//
//  WalkingSpeedProgressView.swift
//  NavitiaSDKUI
//
...
class WalkingSpeedProgressView: UIView {
    ...
    class func instanceFromNib() -> WalkingSpeedProgressView {
        
        return UINib(nibName: String(describing: self), bundle: NavitiaSDKUI.shared.bundle).instantiate(withOwner: nil, options: nil)[0] as! WalkingSpeedProgressView
    }
