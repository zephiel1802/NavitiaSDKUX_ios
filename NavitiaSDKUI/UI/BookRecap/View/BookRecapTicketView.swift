...
open class BookRecapTicketView: UIView {
    ...
    private func _setup() {
        ...
        ticketButton.setAttributedTitle(NSMutableAttributedString().bold("see_my_tickets".localized(withComment: "See my tickets", bundle: NavitiaSDKUI.shared.bundle), color: Configuration.Color.white, size: 12),
                                        for: .normal)
    }
