                ...
                if let type = section.type {
                    switch type {
                        ...
                        case TypeTransport.transfer.rawValue:
                            ...
                            break
                        case TypeTransport.crowFly.rawValue:
                            _displayCrowFlyStep(section)
                            break
                        case TypeTransport.ridesharing.rawValue:
...
extension JourneySolutionRoadmapViewController {
    ...
    private func _drawRidesharingSection(section: Section) -> Bool {
        ...
        if section.type == TypeTransport.ridesharing.rawValue {
    ...
    private func _streetNetworkPolyline(mode: String?, sectionPolyline: inout SectionPolyline) {
        sectionPolyline.sectionStrokeColor = Configuration.Color.gray
        sectionPolyline.sectionLineWidth = 4
    ...
    private func _crowFlyPolyline(mode: String?, sectionPolyline: inout SectionPolyline) {
        sectionPolyline.sectionStrokeColor = Configuration.Color.gray
        sectionPolyline.sectionLineWidth = 4
