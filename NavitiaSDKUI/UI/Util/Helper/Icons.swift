...
let iconFontCodes:[String: String] = [
    ...
    "ticket": "\u{e901}",
    "basket": "\u{ea2d}",
    "payment-denied": "\u{e90b}",
    "user-connection": "\u{e900}",
    "payment": "\u{e91b}",
    "warning-circled": "\u{e919}",
    "user-circled": "\u{e917}",
    "user-connection-circled": "\u{e912}",
    "payment-denied-circled": "\u{e90f}",
    "information-circled": "\u{e90c}",
]
