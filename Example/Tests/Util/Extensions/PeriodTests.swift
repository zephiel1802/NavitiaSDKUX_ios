...
class PeriodTests: XCTestCase {
    ...
    func testContainsWithString() {
        ...
        XCTAssertTrue(period.contains("20170928T140500"))
        XCTAssertTrue(period.contains("20171111T220000"))
        XCTAssertTrue(period.contains("20171201T194459"))
        XCTAssertFalse(period.contains("20180101T001000"))
        XCTAssertFalse(period.contains(""))
    }
}
