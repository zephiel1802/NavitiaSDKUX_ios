...
This SDK provides journey computation screens you can add to your application.
  ...
  s.source_files = 'NavitiaSDKUI/Framedation/**/*.{h,m,swift}', 'NavitiaSDKUI/UI/**/*.{h,m,swift}', 'NavitiaSDKUI/*.{h,m,swift}'
  s.resources = 'NavitiaSDKUI/Resources/**/*.*', 'NavitiaSDKUI/Storyboard/**/*.*'
end
